    ...
    function(t) {
      ...
      s(e, "Core/Axis/Color/ColorAxisComposition.js", [e["Core/Color/Color.js"], e["Core/Utilities.js"]], function(t2, e2) {
        ...
        return (i = s2 || (s2 = {})).initDataClasses = function(t3) {
          ...
          for (let t4 = 0, s4 = l.length; t4 < s4; ++t4)
            a = r(a = l[t4]), n.push(a), (e3.styledMode || !a.color) && ("category" === i2.dataClassColor ? (e3.styledMode || (h = (p = e3.options.colors || []).length, a.color = p[d]), a.colorIndex = d, ++d === h && (d = 0)) : a.color = o(i2.minColor).tweenTo(o(i2.maxColor), s4 < 2 ? 0.5 : t4 / (s4 - 1)));
          ...
          if (n) {
            for (a = n.length; a--; )
              if (i2 = (l = n[a]).from, o2 = l.to, (void 0 === i2 || t3 >= i2) && (void 0 === o2 || t3 <= o2)) {
        ...
        class y extends t2 {
          ...
          getSeriesExtremes() {
            ...
            for (this.dataMin = 1 / 0, this.dataMax = -1 / 0; a2--; ) {
              if (s3 = (l2 = t3[a2]).colorKey = g(l2.options.colorKey, l2.colorKey, l2.pointValKey, l2.zoneAxis, "y"), o2 = l2.pointArrayMap, r2 = l2[s3 + "Min"] && l2[s3 + "Max"], l2[s3 + "Data"])
                e3 = l2[s3 + "Data"];
              else if (o2) {
                if (e3 = [], i2 = o2.indexOf(s3), n2 = l2.yData, i2 >= 0 && n2)
                  for (p2 = 0; p2 < n2.length; p2++)
                    e3.push(g(n2[p2][i2], n2[p2]));
              } else
                e3 = l2.yData;
              if (r2)
                l2.minColorValue = l2[s3 + "Min"], l2.maxColorValue = l2[s3 + "Max"];
              else {
          ...
          destroyItems() {
            ...
            if (e3.label)
              ...
              for (let s3 of e3.labels)
                t3.legend.destroyItem(s3);
          ...
          getDataClassLegendSymbols() {
            ...
            return i2.length || e3.dataClasses.forEach((o3, h2) => {
              ...
              t3 = "", void 0 === d2 ? t3 = "< " : void 0 === u2 && (t3 = "> "), void 0 !== d2 && (t3 += m2(d2, l2) + a2), void 0 !== d2 && void 0 !== u2 && (t3 += " - "), void 0 !== u2 && (t3 += m2(u2, l2) + a2), i2.push(p({ chart: s3, name: t3, options: {}, drawLegendSymbol: r.rectangle, visible: true, isDataClass: true, setState: (t4) => {
                ...
                let t4 = [];
                for (let e4 of n2(h2))
                  e4.setVisible(f2), e4.hiddenInDataClass = !f2, -1 === t4.indexOf(e4.series) && t4.push(e4.series);
          ...
          drawPoints() {
            ...
            if (s3) {
              ...
              if (!e4 || t3.isDirtyData || t3.isDirtyCanvas) {
                ...
                (e4.width !== l2 || e4.height !== n2) && e4.attr(h2);
            } else
              (i2.enabled || t3._hasPointMarkers) && (n.prototype.drawPoints.call(t3), t3.points.forEach((e4) => {
