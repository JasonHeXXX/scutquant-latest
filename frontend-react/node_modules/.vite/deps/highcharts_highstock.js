 ...
 - ${i4}: ${e4}`, l2 && (h2 += encodeURI(i4) + "=" + encodeURI(e4));
          ...
          return t3.forEach((t4) => {
            if (t4.length > 1)
              for (r2 = s2 = t4.length - 1; r2 > 0; r2--)
                (o2 = t4[r2] - t4[r2 - 1]) < 0 && !a2 ? (e3 == null ? void 0 : e3(), e3 = void 0) : o2 && (void 0 === i3 || o2 < i3) && (i3 = o2);
          }), i3;
        ...
        class G {
          ...
          setTickPositions() {
            ...
            if (this.tickmarkOffset = this.categories && "between" === t3.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0, this.single = this.min === this.max && y(this.min) && !this.tickAmount && (this.min % 1 == 0 || false !== t3.allowDecimals), e3)
              n2 = e3.slice();
        ...
        class p {
          static compose(e3, s2) {
            return i2(e3, "afterInit", function() {
              this.labelCollectors.push(() => {
                var _a;
                let t3 = [];
                for (let e4 of this.axes)
                  for (let { label: i3, options: s3 } of e4.plotLinesAndBands)
                    i3 && !((_a = s3 == null ? void 0 : s3.label) == null ? void 0 : _a.allowOverlap) && t3.push(i3);
                return t3;
              });
            }), t2.compose(p, s2);
          }
          ...
          render() {
            ...
            if (!t3.chart.styledMode && (C ? (w.stroke = o2 || "#999999", w["stroke-width"] = c(e3.width, 1), e3.dashStyle && (w.dashstyle = e3.dashStyle)) : M && (w.fill = o2 || "#e6e9ff", x && (w.stroke = e3.borderColor, w["stroke-width"] = x))), p2.zIndex = n2, T += "-" + n2, (k = t3.plotLinesAndBandsGroups[T]) || (t3.plotLinesAndBandsGroups[T] = k = u.g("plot-" + T).attr(p2).add()), v || (this.svgElem = v = u.path().attr(w).add(k)), r(m))
        ...
        class T {
          ...
          refresh(t3, e3) {
            ...
            if (this.distance = M(w2.tooltipOptions.distance, 16), false === C2)
              this.hide();
            else {
              if (this.split && this.allowShared)
                this.renderSplit(C2, n2);
              else {
                let t4 = v2, r2 = k2;
        ...
        class X {
          ...
          setData(t3, e3 = true, i3, s2) {
            ...
            if (h2 && h2.enabled && (t3 = this.sortData(t3)), l2.options.chart.allowMutatingData && false !== s2 && M2 && a2 && !o2.cropped && !o2.hasGroupedData && o2.visible && !o2.boosted && (b2 = this.updateData(t3, i3)), !b2) {
              ...
              for (u2 && R(u2[0]) && w(14, true, l2), o2.data = [], o2.options.data = o2.userOptions.data = t3, x2 = a2; x2--; )
          ...
          update(t3, e3) {
            ...
            if (p2.forEach(function(t4) {
              ...
              for (let t4 of (false === (d2 = i3.options).visible ? (h2.graphic = 1, h2.dataLabel = 1) : (this.hasMarkerChanged(d2, o2) && (h2.graphic = 1), ((_c = i3.hasDataLabels) == null ? void 0 : _c.call(i3)) || (h2.dataLabel = 1)), this.points))
            ...
            if (t3 = t3 || "", i3.state !== t3 && ([i3.group, i3.markerGroup, i3.dataLabelsGroup].forEach(function(e4) {
              ...
              if (t3 && (l2 = a2[t3].lineWidth || l2 + (a2[t3].lineWidthPlus || 0), h2 = G(a2[t3].opacity, h2)), o2 && !o2.dashstyle && j(l2))
                for (let t4 of [o2, ...this.zones.map((t5) => t5.graph)])
                  t4 == null ? void 0 : t4.animate({ "stroke-width": l2 }, n2);
        ...
        class L {
          ...
          proximatePositions() {
            ...
            for (let o2 of (this.allItems.forEach(function(t4) {
              ...
              t3 = o2.item.legendItem || {}, M(o2.pos) && (t3.y = e3.plotTop - e3.spacing[0] + o2.pos);
          }
          render() {
        ...
        function S() {
          ...
          n2 && [s2, "-" + s2].forEach((i4) => {
            ...
            for (; s3--; )
              a3 = r2[s3], t3 = e3.getStackIndicator(t3, a3, e3.index, i4), l2 = (_a = o2[i4]) == null ? void 0 : _a[a3], (h2 = l2 == null ? void 0 : l2.points[t3.key || ""]) && n2.call(e3, h2, l2, s3);
          });
        }
        function k(t3, e3, i3) {
        ...
        return function(t3) {
          ...
          function x(t4) {
            ...
            l(this, "drawDataLabels"), ((_a = i4.hasDataLabels) == null ? void 0 : _a.call(i4)) && (e4 = this.initDataLabels(M), t4.forEach((t5) => {
              ...
              let c3 = o2.length;
              for (; c3--; )
                o2[c3] && o2[c3].isActive ? o2[c3].isActive = false : ((_b = o2[c3]) == null ? void 0 : _b.destroy(), o2.splice(c3, 1));
            ...
            t3.visible && ((_a = t3.hasDataLabels) == null ? void 0 : _a.call(t3)) && (e4.forEach((t4) => {
              ...
              h2 && (t3.sortByAngle(e5, a3 - 0.5), k > 0 && (f2 = Math.max(0, g2 - c2 - k), m3 = Math.min(g2 + c2 + k, i4.plotHeight), e5.forEach((t4) => {
                ...
                (i5.dataLabels || []).forEach((l2) => {
                  ...
                  if (f3) {
                    if (d2 && p(g3) && f3.distance > 0 && (void 0 === g3.pos ? w = "hidden" : (S = g3.size, A = y.radialDistributionY(i5, l2))), h3.justify)
                      C = y.justify(i5, l2, c2, n2);
                    else
                      switch (h3.alignTo) {
                        case "connectors":
        ...
        function n(t3) {
          ...
          for (let i3 = 0; i3 < e3; i3++)
            (a2 = t3[i3]) && (a2.oldOpacity = a2.opacity, a2.newOpacity = 1, a2.absoluteBox = function(t4) {
              var _a, _b;
        ...
        function h() {
          ...
          for (let i3 of t3.yAxis || [])
            i3.stacking && i3.options.stackLabels && !i3.options.stackLabels.allowOverlap && r(i3.stacking.stacks, (t4) => {
              r(t4, (t5) => {
        ...
        return function(t3) {
          ...
          function d() {
            ...
            if (n2 && h2) {
              ...
              if (h2[t4] += n2.size + (n2.options.margin || 0), isNaN(o2) || isNaN(a2) || !r(this.min) || !r(this.max) || this.dataMin === this.dataMax)
                n2.setRange(0, 1);
              else if (this.min === this.max) {
                let t5 = this.pointRange / (this.dataMax + 1);
                e4 = t5 * this.min, s2 = t5 * (this.max + 1), n2.setRange(e4, s2);
              } else
                e4 = (this.min - o2) / (a2 - o2), s2 = (this.max - o2) / (a2 - o2), this.horiz && !this.reversed || !this.horiz && this.reversed ? n2.setRange(e4, s2) : n2.setRange(1 - s2, 1 - e4);
            }
          }
        ...
        class P {
            ...
            if ([!i3, i3, !i3].forEach((i4, o3) => {
              ...
              [0, 1].forEach((e4) => {
                ...
                if (t3.handles[e4] && t3.handles[e4].symbolUrl === h2) {
                  ...
                  (_a2 = t3.handles[e4]) == null ? void 0 : _a2.destroy(), t3.handles[e4] = r2.symbol(h2, -l2 / 2 - 1, 0, l2, o3, i4), t3.handles[e4].attr({ zIndex: 7 - e4 }).addClass("highcharts-navigator-handle highcharts-navigator-handle-" + ["left", "right"][e4]).add(n2), t3.addMouseEvents();
          ...
          update(t3, e3 = false) {
            ...
            if (M(true, i3.options.navigator, t3), this.navigatorOptions = i3.options.navigator || {}, this.setOpposite(), f(t3.enabled) || s2)
              return this.destroy(), this.navigatorEnabled = t3.enabled || this.navigatorEnabled, this.init(i3);
          ...
          init(e3) {
            ...
            if (e3.isDirtyBox = true, u2.navigatorEnabled) {
              ...
              u2.xAxis = { chart: e3, navigatorAxis: { fake: true }, translate: function(t3, i4) {
        ...
        return function(t3) {
          function s2(t4, e3, i3, o3, r2 = [], a2 = 0, n2) {
            ...
            if (!this.options.ordinal && !this.options.breaks || !r2 || r2.length < 3 || void 0 === e3)
              return u2.getTimeTicks.apply(u2, arguments);
            let M2 = r2.length;
            for (f2 = 0; f2 < M2; f2++) {
              if (b2 = f2 && r2[f2 - 1] > i3, r2[f2] < e3 && (v2 = f2), f2 === M2 - 1 || r2[f2 + 1] - r2[f2] > 5 * a2 || b2) {
                if (r2[f2] > k2) {
                  for (m2 = u2.getTimeTicks(t4, r2[v2], r2[f2], o3); m2.length && m2[0] <= k2; )
                    m2.shift();
            ...
            if (m2) {
              if (y2 = m2.info, n2 && y2.unitRange <= p.hour) {
                for (v2 = 1, f2 = S2.length - 1; v2 < f2; v2++)
                  u2.dateFormat("%d", S2[v2]) !== u2.dateFormat("%d", S2[v2 - 1]) && (d2[S2[v2]] = "day", x2 = true);
            ...
            if (n2 && l(c2)) {
              ...
              for (; h2--; )
                r3 = this.translate(S2[h2]), a3 && (s3[h2] = a3 - r3), e4[h2] = a3 = r3;
              for (s3.sort((t6, e5) => t6 - e5), (n3 = s3[Math.floor(s3.length / 2)]) < 0.6 * c2 && (n3 = null), h2 = S2[t5 - 1] > i3 ? t5 - 1 : t5, a3 = void 0; h2--; )
                l2 = Math.abs(a3 - (r3 = e4[h2])), a3 && l2 < 0.8 * c2 && (null === n3 || l2 < 0.8 * n3) ? (d2[S2[h2]] && !d2[S2[h2 + 1]] ? (o4 = h2 + 1, a3 = r3) : o4 = h2, S2.splice(o4, 1)) : a3 = r3;
            }
            return S2;
          }
          function o2(t4) {
